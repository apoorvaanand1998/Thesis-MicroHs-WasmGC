...
combs = [ "S", "K", "I", "B", "C",
          ...
          "K2", "K3", "K4", "CCB",
          "ADD", "IOBIND", "IORETURN", "IOTHEN",
          "AND",
          "A.alloc", "ARR",
          "SUB", "MUL", "QUOT", "REM", "SUBR", "UQUOT", "UREM", "NEG",
...
toWatInstr (MkNode c v) = fromComb c ++ fromVal v ++ [StructNew AppNodeType]
...
prim :: String -> Instr
prim x = maybe (RefI31 (-1)) RefI31 (elemIndex x combs)
-- -1 for now means not implemented primop
-- Use the below version once you support all primitives
